// Curated Lucide icon set. GENERATED - do not edit by hand.
//
...
export const LUCIDE = {
  ...
  "credit-card": [["rect",{"width":"20","height":"14","x":"2","y":"5","rx":"2"}],["line",{}]],
  ...
  "gamepad-2": [["line",{}],["line",{}],["line",{}],["line",{}],["path",{"d":"M17.32 5H6.68a4 4 0 0 0-3.978 3.59c-.006.052-.01.101-.017.152C2.604 9.416 2 14.456 2 16a3 3 0 0 0 3 3c1 0 1.5-.5 2-1l1.414-1.414A2 2 0 0 1 9.828 16h4.344a2 2 0 0 1 1.414.586L17 18c.5.5 1 1 2 1a3 3 0 0 0 3-3c0-1.545-.604-6.584-.685-7.258-.007-.05-.011-.1-.017-.151A4 4 0 0 0 17.32 5z"}]],
  ...
  "monitor": [["rect",{"width":"20","height":"14","x":"2","y":"3","rx":"2"}],["line",{}],["line",{}]],
  ...
  "percent": [["line",{}],["circle",{"cx":"6.5","cy":"6.5","r":"2.5"}],["circle",{"cx":"17.5","cy":"17.5","r":"2.5"}]],
...
export const ICON_GROUPS = [
  { label: "Food", names: ["utensils","utensils-crossed","coffee","pizza","beef","cake","apple","ice-cream-cone","wine","beer","milk","cookie"] },
  { label: "Transport", names: ["car","bus","train-front","plane","bike","fuel","ship","car-taxi-front","circle-parking","map-pin","footprints","truck"] },
  { label: "Home", names: ["house","sofa","bed","lamp","lightbulb","droplet","flame","wrench","hammer","key","washing-machine","trash-2"] },
  { label: "Bills", names: ["receipt","file-text","zap","phone","tv","wifi","router","calendar","clock","signal","shield","umbrella"] },
  { label: "Shopping", names: ["shopping-bag","shopping-cart","shopping-basket","shirt","gift","tag","store","package","watch","glasses","gem","scissors"] },
  { label: "Health", names: ["heart-pulse","pill","dumbbell","stethoscope","syringe","cross","brain","bandage","activity","hospital"] },
  { label: "Fun", names: ["music","gamepad-2","film","ticket","camera","headphones","palette","book-open","party-popper","tent","dices","guitar"] },
  { label: "Money", names: ["wallet","landmark","credit-card","piggy-bank","coins","banknote","hand-coins","receipt-text","vault","circle-dollar-sign","arrow-left-right","trending-up","trending-down","percent"] },
  { label: "Work", names: ["briefcase","laptop","graduation-cap","book","pen-tool","printer","building-2","users","monitor","smartphone","globe","mail"] },
  { label: "Other", names: ["star","heart","sprout","leaf","paw-print","dog","cat","baby","sun","moon-star","circle-help","ellipsis"] }
];
