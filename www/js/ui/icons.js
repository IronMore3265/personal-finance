...
const ICONS = {
  ...
  // The app lock's own mark: a thumbprint, drawn as nested arcs rather than
  // the full Lucide whorl, which turns to mud below 20px.
  fingerprint: [
    ['path', { d: 'M12 11v2.5a7 7 0 0 1-1.2 3.9' }],
    ['path', { d: 'M8.6 8.9a4.4 4.4 0 0 1 6.8 3.6c0 1.6-.2 3.1-.7 4.6' }],
    ['path', { d: 'M5.8 14.2A7.6 7.6 0 0 1 5.4 12a6.6 6.6 0 0 1 13.2 0c0 2.3-.3 4.5-.9 6.6' }],
    ['path', { d: 'M4.2 7.6a9.5 9.5 0 0 1 15.6 0' }]
  ],
  gear: [
